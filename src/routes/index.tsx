import { component$, useContextProvider, useStore, useOnWindow, $ } from '@builder.io/qwik';
import type { DocumentHead } from '@builder.io/qwik-city';
import type { Profile } from '~/context/context';
import { profileContext } from '~/context/context';
import { getUserData, infiniteScrollToGetRepos } from '~/components/profile/profile';
...
export default component$(() => {
  ...
  return (
    <div>
      ...
      <div class="flex flex-col z-10 relative min-h-screen scroll-smooth">
        <form class="flex flex-row items-center justify-center"
              preventdefault:submit
              onSubmit$={async (e) => {
                const data = await getUserData((e.target as HTMLFormElement).username.value)
          ...
          <input  type="text"
                  ...
                  class="bg-blue-100 outline-none w-3/4 md:w-1/2 bg-opacity-50
                          mr-4 mt-4 p-1 md:p-2 border-2 border-blue-600 rounded backdrop-blur placeholder:text-slate-500"/>
